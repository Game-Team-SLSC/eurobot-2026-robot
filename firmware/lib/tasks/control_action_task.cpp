                ...
                case robot::config::Action::TURN:
                    {
                        ...
                        cmd33.controller = robot::config::front_right_grabber.controller;
                        cmd33.pin = robot::config::front_right_grabber.pin;
                        cmd33.value = 0;
                        pwmBatch.add(cmd33);

                        PWMCommand cmd22;

                        cmd22.controller = robot::config::front_left_grabber.controller;
                        cmd22.pin = robot::config::front_left_grabber.pin;
                        cmd22.value = 168;
                        pwmBatch.add(cmd22);
                ...
                case robot::config::Action::STOCK:
                    {
                        ...
                        CommandBatch<PWMCommand> pwmCommand2;
                        ...
                        cmd1.pin = robot::config::front_left_turner.pin;
                        cmd1.value = 20;
                        pwmCommand2.add(cmd1);

                        PWMCommand cmd3;
                        cmd3.controller = robot::config::front_right_turner.controller;
                        cmd3.pin = robot::config::front_right_turner.pin;
                        cmd3.value = 160;
                        pwmCommand2.add(cmd3);

                        
                        xQueueSend(robot::queues::pwm_command_queue, &pwmCommand2, 0);
